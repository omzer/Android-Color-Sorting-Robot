package com.example.colorsortrobot.matchine_learning
...
class ColorsClassifier(private val activity: Activity) {
    ...
    private fun getModelPath(): String = "colors_model.tflite"
    private fun getLabelsPath(): String = "colors_model_labels.txt"
